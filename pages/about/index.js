      ...
      <Container>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-[30px] px-[10px] lg:px-[0px] my-[40px] md:my-[60px] lg:my-[100px] ">
          <div className="about">
            ...
            <h5 className="lg:text-[32px] text-[26px] font-bold text-blackColor">
              10.5k
            </h5>
          ...
          <div className="about bg-secondaryRed border-none">
            ...
            <h5 className="lg:text-[32px] text-[26px] font-bold text-whiteColor pb-4">
              33k
            </h5>
            <p className="text-[14px]  lg:text-[16px] text-whiteColor  font-medium tracking-wider">
            ...
            {sliderInfo?.map((item) => (
              <SwiperSlide key={item.id}>
                <div className=" cursor-pointer  mb-[50px] px-[10px] lg:px-[0px]">
                  ...
                  <h3 className="text-[26px] lg:text-[32px] text-blackColor font-medium mt-[8px]">
                    {item?.name}
                  </h3>
                  <p className="text-[16px] text-blackColor tracking-wider mb-[10px]">
                    {item.title}
                  </p>
                  <p className="text-[18px] lg:px-[35px] px-[10px] tracking-widest font-[400] leading-[25px] text-[#aaa1a1cc]">
                    {item.desc}
                  </p>
                </div>
              </SwiperSlide>
        ...
        <div className="grid grid-cols-1 max-w-[950px] sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-[30px] px-[10px] lg:px-[0px] my-[40px] md:my-[60px] lg:my-[100px] mx-auto">
          <div className="flex flex-col justify-center mx-auto text-center">
            ...
            <h3 className="lg:text-[20px] text-[16px] text-blackColor font-semibold mt-[5px] mb-[5px]">
              FREE AND FAST DELIVERY
            </h3>
            <p className="text-[14px] text-primaryBlack">
